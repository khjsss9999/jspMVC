...
<body>
	...
	<h3>
		...
		<li><fmt:formatNumber value="123456.a5749" /></li> 문자가 섞이면 오류가 난다. --%>
	</h3>
	
	<h2>숫자 , 숫자 문자 일때는 처음부터 숫자까지만 인식</h2>
	<h3>
		<li><fmt:parseNumber value="123456.5749" /></li> <%-- 콤마 표시는 안 나온다. --%>
		<li><fmt:parseNumber value="123c4b56.a5749" /></li>  <%-- 문자가 나오기 전 까지는 출력이 된다. --%>
		<%-- <li><fmt:parseNumber value="aaa123456.5749" /></li> 처음에는 문자가 오면 오류가 난다.--%>
	</h3>
	
	<h2>정수만 구하기(반올림 처리)</h2>
	<h3>
		<li><fmt:formatNumber value="11123456.4749" pattern="#,###" /></li>
	...
	<h2>현재 운영체제에 맞는 화폐단위 표시 (반올림됨)</h2>
	<h3>
		<li><fmt:formatNumber value="11123456.4749" type="currency" /></li>
